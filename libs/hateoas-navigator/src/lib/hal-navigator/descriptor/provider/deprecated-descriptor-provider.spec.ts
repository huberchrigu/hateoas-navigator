...
import {DeprecatedDescriptorProvider} from './deprecated-descriptor-provider';
import {ModuleConfiguration} from '../../config';

describe('DeprecatedDescriptorProvider', () => {
  ...
  it('should resolve titles', async(() => {
    const testee = new DeprecatedDescriptorProvider({} as ModuleConfiguration, schemaService);
